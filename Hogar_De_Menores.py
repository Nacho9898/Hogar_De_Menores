...
def ingresar_datos():
    ...
    while intentos > 0:
        ...
        if not re.match(r'^\d{8}$', fecha_nacimiento):
            ...
            datos["Fecha de nacimiento (DDMMAAAA)"] = fecha_nacimiento
            break
...
if iniciar_sesion():  # Verifica si el inicio de sesión es exitoso
    while True:
