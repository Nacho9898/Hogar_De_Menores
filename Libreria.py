...
def ingresar_datos():
    ...
    intentos = 3
    while intentos > 0:
        fecha_nacimiento = "15-06-2024"
        fecha_nacimiento = input("Ingrese la fecha de nacimiento del menor (DD-MM-AAAA): ") 
    ...
    while True:
        sala = input("""Ingrese la sala a la que pertenece el menor 
(con una letra mayúscula y 1 o 2 números del 0 al 5): """)
...
def consultar_datos(datos):
    if datos:
        ...
        for key, value in datos.items():
            if key == "Fecha de nacimiento (DD-MM-AAAA)":
